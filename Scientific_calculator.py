#Import different modules to build the app
from tkinter import *
import math
...
# sets the name on top
root.title("Codecodix scientific calculator")

# background color of calculator as white
root.configure(background = 'white')

#width and height of the Layout
#Can´t be expanded/stretched
...
#Class to contain the functions to use in calculator
...
#display in the GUI of the calculator
...
# place all the buttons/operators in their respective position in the grid
